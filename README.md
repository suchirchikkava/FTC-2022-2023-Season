...
//private Servo backArm;
    ...
    private final double closeHand = 0.1;
    private final double openHand = 0.3;
    ...
    public void gripBack (boolean closed) {
        /*if (!closed)
            backClaw.setPosition(openHand);
        else
            backClaw.setPosition(closeHand);*/
    }
    public void gripFront(boolean closed) {
        /*
        if (!closed)
            frontClaw.setPosition(openHand);
        else
            frontClaw.setPosition(closeHand);
         */
    }
